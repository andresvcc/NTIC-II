...
export default class ScreenCapture extends Component {
  ...
  handleMouseMove = (e) => {
    const {
      isMouseDown, windowWidth, windowHeight, startX, startY, borderWidth
    } = this.state;
  ...
  handleClickTakeScreenShot = () => {
    const {
      cropPositionTop, cropPositionLeft, cropWidth, cropHeigth
    } = this.state;
      ...
      <ScreenCapture onEndCapture={handleScreenCapture}>
        {({ onStartCapture }) => (
          <>
            ...
            <br />
            <br />
            <img src={screenCaptureIMG || `${__API__}/notPhoto.png`} alt="YXC" />
          </>
        )}
      </ScreenCapture>
